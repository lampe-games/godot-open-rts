...
func _hit_target():
	...
	var dir = (_target_unit.global_position - projectile_origin.global_position).normalized()
	var new_projectile = _PSH.Projectile.new_with_pos(projectile_origin.global_position, dir, 3000)
